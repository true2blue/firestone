    ...
    <b-container>
      <b-row no-gutters>
        <b-col lg="6">
          ...
          <b-row no-gutters>
            <b-col lg="4">
              <label for="multibuy">分批:</label>
            </b-col>
            <b-col lg="2">
              <label for="max_buy_count">次数:</label>
            </b-col>
            <b-col lg="2">
              <b-form-input
                size="sm"
                ...
                min="-10.0"
                max="10.0"
                v-model="strategy.parameters.max_buy_count"
              ></b-form-input>
            </b-col>
            <b-col lg="2">
              <label for="limit_open_percent">开盘涨幅:</label>
            </b-col>
            <b-col lg="2">
              <b-form-input
                size="sm"
                ...
                min="-10.0"
                max="10.0"
                v-model="strategy.parameters.limit_open_percent"
              ></b-form-input>
            </b-col>
          </b-row>
          <b-row no-gutters>
            <b-col lg="4">
              <label for="drop_down">下跌:</label>
            </b-col>
            <b-col lg="2">
              <label for="drop_open_percent">跌幅:</label>
            </b-col>
            <b-col lg="2">
              <b-form-input
                size="sm"
                ...
                min="-10.0"
                max="10.0"
                v-model="strategy.parameters.drop_open_percent"
              ></b-form-input>
            </b-col>
          </b-row>
          <b-row no-gutters>
